...
PPATH="/mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer"
cd "$PPATH"
...
#============================================================================================
#---------------------------
Word_model_path='/mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer/Tokenizers/models/Timit_PHSEQ_100/Timit_PHSEQ__100__word.model'
Char_model_path='/mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer/Tokenizers/models/Timit_PHSEQ_100/Timit_PHSEQ__100__word.model'

text_file='/mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer/Tokenizers/All_text_39phseq'
...
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer/ASR_TransV1/Make_training_scps.py \
						--data_dir $data_dir \
 						--text_file $text_file \
...
#==============================================================================================
# #---------------------------------------------------------------------------------------------
stdbuf -o0  python /mnt/matylda3/vydana/HOW2_EXP/ASR_Transformer/ASR_TransV1/Transformer_training.py \
 						--gpu $gpu \
 						--text_file $text_file \
 						--train_path $train_path \
 						--dev_path $dev_path \
