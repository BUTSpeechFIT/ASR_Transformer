...
format_tokenize_data(scp_file=glob.glob(args.train_path + "*"),transcript=args.text_file,Translation=args.text_file,outfile=open(join(args.data_dir,'train_scp'),'w'),Word_model=args.Word_model_path,Char_model=args.Char_model_path)
format_tokenize_data(scp_file=glob.glob(args.dev_path + "*"),transcript=args.text_file,Translation=args.text_file,outfile=open(join(args.data_dir,'dev_scp'),'w'), Word_model=args.Word_model_path,Char_model=args.Char_model_path)
