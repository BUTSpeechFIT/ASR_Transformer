...
from Trans_MHA import MultiHeadAttention, PositionwiseFeedForward, PositionalEncoding, MultiHeadAttention_Fnet, PositionwiseFeedForward_Fnet
...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, d_inner, n_head, d_k, d_v, dropout=0.1,ff_dropout=0.1):
        ...
        self.slf_attn = MultiHeadAttention_Fnet(n_head, d_model, d_k, d_v, dropout=dropout)
        self.pos_ffn = PositionwiseFeedForward_Fnet(d_model, d_inner, dropout=ff_dropout)
